...
- 2026-05 に発表された「Agent SDK / `claude -p` / サードパーティアプリをサブスク枠から切り離して従量課金へ移す」変更は 2026-06-15 に一時停止され、現在もサブスク枠から消費される状態が続いているとされる。**未確認**(記事本文を再取得できず)(https://thenewstack.io/anthropic-pauses-claude-agent-sdk-subscription-change/, 確認 2026-09-06, 確度 低)
