...
3. **Open at least one primary source yourself and read the quote you are going to rely on.** Never carry a claim into a decision on hearsay: the worker's summary is one restatement away from the source, and the difference is exactly where terms of service go wrong. Anything you could not confirm stays marked as unconfirmed.
